            ...
            <div class="panel shadow">
                ...
                <div class="inside">
                    ...
                    <div class="custom-file">
                        {!! Form::file('icon', ['class' => 'form-control form-control-sm', 'required','id' => 'formFileSm', 'accept' => "image/*"]) !!}
                    </div>
                         ...
                         <tr>
                             ...
                             <td>
                                <div class="opts">
                                    ...
                                    <a href="{{ url('/admin/category/'.$cat->id.'/subs') }}" data-toggle="tooltip" data-bs-placement="top" data-bs-title="Subcategories">
